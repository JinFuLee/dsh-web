...
window.SKIN_MANIFEST = {
  ...
  "skins": [
    ...
    },
    {
      ...
      "nameEn": "Hatsune Miku",
      "author": "涂山苏苏",
      "tagline": "初音青绿机甲方格 · 明暗双主题独立配色 · 会话栏全透明露出壁纸",
      "description": "初音未来主题的整体重做：明亮档是青空舞台（冷调青白平涂 + 墨蓝描边 + 硬投影），暗色档是夜海霓虹（深蓝平涂 + 青绿冷光边 + 品红高光），两套配色各自独立；会话栏完全透明让壁纸直通，面板改用机甲斜切角、拉丝金属与青蓝品红渐变描边，输入区做成座舱凹槽并配主题色光标，左上角字标为代号铭牌加渐变名号；界面字体换成 Bahnschrift 几何无衬线，顶栏与底栏收起，正文与设置面板按明暗两套分别校验可读性。",
      "accent": "#39c5bb",
      "preview": {
    ...
    },
    {
      "id": "phoebe-atelier",
      "name": "辉弦圣堂 · 菲比",
      "nameEn": "Radiant Strings Atelier",
      "author": "Theater-ahyeon",
      "tagline": "双立绘圣堂背景 · 象牙白大理石廊柱侧栏 · 光环动效",
      "description": "《鸣潮》菲比主题的高定制皮肤：双立绘与光弦圣堂场景垫在对话区之下，象牙白大理石廊柱侧栏与月白圣金 token 重映射覆盖全部 dsw 语义变量，为加载、思考与工具运行状态预留光弦/光环动效钩子。角色形象为 AI 辅助同人再创作，仅限非商业使用。",
      "accent": "#cfa968",
      "preview": {
        "light": "assets/skins/phoebe-atelier/preview/light.jpg",
        "dark": "assets/skins/phoebe-atelier/preview/dark.jpg"
      },
      "contributes": {
        "stylesheet": "skin.css",
        "backgroundMedia": {
          "light": {
            "type": "image",
            "src": "assets/skins/phoebe-atelier/assets/palace-light.webp",
            "scrim": "linear-gradient(rgba(250, 247, 240, 0.1) 0%, rgba(244, 243, 248, 0.16) 55%, rgba(238, 241, 248, 0.22) 100%)"
          },
          "dark": {
            "type": "image",
            "src": "assets/skins/phoebe-atelier/assets/palace-dark.webp",
            "scrim": "linear-gradient(rgba(10, 14, 34, 0.18) 0%, rgba(12, 17, 40, 0.3) 60%, rgba(8, 11, 28, 0.4) 100%)"
          }
        }
      }
    },
    ...
    },
    {
      ...
      "nameEn": "Anime Pixel",
      "author": "stushansusu",
      "tagline": "椰影沙滩 · 银河星海 · 棋盘抖动 · 精灵描边",
      "description": "同一个海岸的两段时间。明亮是白昼的沙滩椰林：暖沙地、湿沙的水痕、断断续续的浪线、近岸泛青的海，椰子树用二十格高的点阵剪影立在沙上，天上挂着一颗带八条光芒的阶梯太阳和四朵点阵云；暗色是深夜的星空银河：夜空蓝黑、二百三十颗点阵星加一条由淡点堆出来的银河拱、右上角一枚下弦月，海平线往上是月亮照亮的暖褐滩涂，水里压着几道月光与星光。两套都不靠渐变——明暗是 8px 一格的棋盘抖动堆出来的，像素画里没有平滑 ramp。所有圆角归零（像素画只有直角和 45 度），每张卡片一圈 2px 精灵描边加 4px 实心投影。整片海岸画在画布层（沙 286px、海 134px，锚在底边），而画布与机壳之间不留任何中间层：bg-base 全透明，会话背景与主页背景是同一幅画。侧栏的文件夹行是沙台、选中行下缘压一道碎浪，输入卡下缘也是碎浪、发送键是落日橙（夜里银河紫），工具行与用户气泡共用同一个实心底色。",
      "accent": "#0F7182",
      "preview": {
        "light": "assets/skins/pixel-anime/preview/light.jpg",
        "dark": "assets/skins/pixel-anime/preview/dark.jpg"
      },
      "contributes": {
        "stylesheet": "skin.css",
        "patches": "patches.css"
    ...
    },
    {
      ...
      "author": "stushansusu",
      "tagline": "纯暗色 · 黑漆底 · 描金线 · 缠枝角花 · 鎏金立绘",
      "description": "暗色专用皮肤：无论系统设为浅色还是深色，呈现的都是同一套黑漆鎏金，所以两个主题的预览图完全一致。暖黑漆底、淡香槟金正文、金属渐变主按钮；深色值同时写在 :root 与 body[data-ds-dark-theme] 上，装饰规则不再分支，并用 html { color-scheme: dark !important } 压住跟随系统的原生控件配色。另补齐了官方「永不派生」的 14 个按钮/遮罩类 token——否则它们在浅色模式下会退回官方浅色值（「回到底部」按钮就会变成白色圆钮）。装饰层：四角缠枝角花、顶部回纹带、双线描金边、金箔碎屑与金属拉丝、菜单栏描金双线边与鎏金鲸鱼印、回合云纹分隔线、输入卡开光、工作区描金匾额、字标徽章，以及右侧羽化的鎏金立绘（blur 1.7px，整层羽化并外扩 48px 以免视口边缘虚化）。审批面板另有朱批钤印。纯 CSS，无 hooks。",
      "accent": "#c9ab6e",
      "preview": {
        "light": "assets/skins/black-gold/preview/light.jpg",
        "dark": "assets/skins/black-gold/preview/dark.jpg"
      },
      "contributes": {
        "stylesheet": "skin.css",
        "patches": "patches.css"
    ...
    },
    {
      "id": "ice-princess",
      "name": "冰晶公主",
      "nameEn": "Ice Crystal Princess",
      "author": "stushansusu",
      "tagline": "纯暗色 · 霜棱画框 · 冰晶切面 · 六出雪花 · 风雪视差 · 配套桌宠立绘",
      "description": "暗色专用皮肤：无论系统设为浅色还是深色，呈现的都是同一套冰殿，所以两个主题的预览图一致（实测两态逐像素差 0%）。配色直接取自桌面宠物「冰晶公主」的立绘设定——主深蓝 #1A4B94 是外袍与蝴蝶结，中宝蓝 #3277D8 是衣饰与宝石，浅天蓝 #63B8F0 是发梢高光与裙摆渐变，亮白 #FFFFFF 是衣身与长袜，银灰 #D6E4F5 走腰带与镶边，瞳色 #589CE6 是那双眼睛；整套唯一的暖色是肤色 #F9DDD0，只留在首屏霜环正中心。装饰层走「冰殿」引擎：四角霜棱角花（同一母题镜像四次）、六棱冰印、开光角线、霜纹分隔线、切面冰宝石主按钮；首屏是六出雪花霜环，工作区面板是冰壁。背景为角色立绘，人物缩放 0.85、水平中心 65%，四周用无结构色场铺底并做椭圆羽化；其上叠两层雪片贴图做从左向右的风雪，两层贴图宽度不同（1400/900px）故产生视差，并尊重 prefers-reduced-motion。",
      "accent": "#3277D8",
      "preview": {
        "light": "assets/skins/ice-princess/preview/light.jpg",
        "dark": "assets/skins/ice-princess/preview/dark.jpg"
      },
      "contributes": {
        "stylesheet": "skin.css",
        "patches": "patches.css",
        "backgroundMedia": {
          "light": {
            "type": "image",
            "src": "assets/skins/ice-princess/assets/bingjing-bg.webp",
            "scrim": "linear-gradient(180deg, rgba(7,14,30,0.42) 0%, rgba(7,14,30,0.5) 45%, rgba(7,14,30,0.68) 100%)"
          },
          "dark": {
            "type": "image",
            "src": "assets/skins/ice-princess/assets/bingjing-bg.webp",
    ...
    },
    {
      "id": "whale-maid",
      "name": "鲸鱼娘·望海",
      "nameEn": "Whale Girl · Sea Gaze",
      "author": "stushansusu",
      "tagline": "白昼海岸 · 蓝发女仆抱鲸 · 蕾丝白纱 · 深海夜",
      "description": "两套光共用一张画：白昼是原图的海岸午后（蓝天、白浪、灯塔、抱着鲸鱼玩偶的蓝发女仆），夜里把同一张画重新打光成月下的深海，人物与构图一个像素都不移动。界面走赛璐璐的画法——墨线、硬投影、平涂——但面全部换成「白纱」：有颜色、有玻璃、有蕾丝网眼，看得见后面的人。海的纹样只有三种：蕾丝网眼（两组错开半个周期的点阵）、青海波鳞纹（两层错开的半圆浪线），以及从海底升上来的两层视差气泡。",
      "accent": "#2E6FD0",
      "preview": {
        "light": "assets/skins/whale-maid/preview/light.jpg",
        "dark": "assets/skins/whale-maid/preview/dark.jpg"
      },
      "contributes": {
        "stylesheet": "skin.css",
        "patches": "patches.css",
        "backgroundMedia": {
          "light": {
            "type": "image",
            "src": "assets/skins/whale-maid/assets/whale-day.webp",
            "scrim": "linear-gradient(106deg, rgba(234,244,253,0.4) 0%, rgba(234,244,253,0.2) 34%, rgba(234,244,253,0.04) 64%, rgba(234,244,253,0) 100%)"
          },
          "dark": {
            "type": "image",
            "src": "assets/skins/whale-maid/assets/whale-night.webp",
            "scrim": "linear-gradient(106deg, rgba(5,14,32,0.52) 0%, rgba(5,14,32,0.26) 34%, rgba(5,14,32,0.06) 64%, rgba(5,14,32,0) 100%)"
          }
        }
      }
    }
